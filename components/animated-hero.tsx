...
const copy = {
  en: { eyebrow: "Zouhour Bellamine · Monastir, Tunisia", titleStart: "Making", titleEmphasis: "intelligent", titleEnd: "ideas feel beautifully real.", description: "AI Engineer and Software Engineer building thoughtful systems across machine learning, generative AI, RAG, and computer vision.", work: "Explore my work", contact: "Let's connect", cv: "Download CV", portrait: "Portrait placeholder", portraitNote: "Place", note: "AI ↗ SOFTWARE ↗ CREATIVE SYSTEMS" },
  fr: { eyebrow: "Zouhour Bellamine · Monastir, Tunisie", titleStart: "Des idées", titleEmphasis: "intelligentes", titleEnd: ", rendues réelles avec soin.", description: "Ingénieure IA et ingénieure logiciel, je conçois des systèmes réfléchis en machine learning, IA générative, RAG et vision par ordinateur.", work: "Découvrir mes projets", contact: "Me contacter", cv: "Télécharger le CV", portrait: "Portrait à ajouter", portraitNote: "Ajoutez", note: "IA ↗ LOGICIEL ↗ SYSTÈMES CRÉATIFS" },
};
